...
('Blow out dust from kiosks', 'COMMON', 30);
insert into tasks (description, priority, frequency) values
    ('Clean top and main screens of kiosks', 'COMMON', 30);
insert into tasks (description, priority, frequency) values
    ('Clean the touch screen and check mas-touch', 'COMMON', 30);
insert into tasks (description, priority, frequency) values
    ('Analysing kiosk monthly performance identifying common faults and problems.', 'COMMON', 30);
insert into tasks (description, priority, frequency) values
