...
public class ScheduleController {
  ...
  public ResponseEntity<Schedule> update(@RequestBody ScheduleDto scheduleDto)
  ...
  public ResponseEntity<Void> grabSchedule(
      @PathVariable Long scheduleId, @AuthenticationPrincipal UserDetails userDetails) {

    log.info(
        "Handling schedule grab with id: {} by user: {}", scheduleId, userDetails.getUsername());
  ...
  public ResponseEntity<Void> releaseSchedule(
      @PathVariable Long scheduleId, @AuthenticationPrincipal UserDetails userDetails) {

    log.info(
        "Handling schedule release with id: {} by user: {}", scheduleId, userDetails.getUsername());
  ...
  public ResponseEntity<Schedule> findById(@PathVariable Long scheduleId)
      throws ValidationException, NotFoundException {
  ...
  public ResponseEntity<Page<ScheduleDto>> findAll(
    ...
    Page<ScheduleDto> schedulesPageResponseBody =
        scheduleService.findAllSortedByTaskPriority(page, pageSize);
  ...
  public ResponseEntity<Page<ScheduleDto>> findAllNotCompletedByUser(
    ...
    log.info(
        "Handling for user:{} find all NOT COMPLETED schedules page: {} with size: {}",
        userDetails,
        page,
        pageSize);
    ...
    Page<ScheduleDto> schedulesPageResponseBody =
        scheduleService.findAllSortedByTaskPriorityAndByEndExecutionDateTimeNullAndByUserEmail(
            page, pageSize, email);
    return ResponseEntity.ok().body(schedulesPageResponseBody);
  }
  ...
  public ResponseEntity<Page<Schedule>> findAllNotCompletedByPriorityIndexByUser(
    ...
    log.info(
        "Handling for user:{} find all NOT COMPLETED schedules SORTED BY OPTIMIZATION INDEX page: {} with "
            + "size: {}",
        userDetails,
        page,
        pageSize);
    ...
    Page<Schedule> schedulesPageResponseBody =
        scheduleService.findAllSortedByOptimizationIndexAndByEndExecutionDateTimeNullAndByUserEmail(
            page, pageSize, email);
    return ResponseEntity.ok().body(schedulesPageResponseBody);
  }
}
