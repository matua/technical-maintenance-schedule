...
public class ControllerExceptionHandler {
  ...
  public ResponseEntity<CustomExceptionMessage> validationException(
  ...
  public ResponseEntity<CustomExceptionMessage> alreadyExistsException(
  ...
  public ResponseEntity<CustomExceptionMessage> notAuthorizedException(
