...
//
//    log.info(
//        "Getting optimal route via Google Java Client API and returning list of terminals in an
// optimized "
//            + "order");
//
//    try {
...
//          getDirectionsResultWithLatLngStartAndFinishPoint(startAndFinishPoint,
// terminalLocations);
//      final List<Terminal> terminals =
//          convertArrayOfGeocodeWayPointsToListOfTerminals(terminalLocations, result.routes);
//      geoApiContext.shutdown();
...
//
//    log.info(
//        "Getting optimal route via Google Java Client API and returning an optimized order as an
// Integer "
//            + "array ");
//
//    try {
