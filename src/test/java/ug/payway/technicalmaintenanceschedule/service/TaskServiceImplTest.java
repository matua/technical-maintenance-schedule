...
//        assertThrows(ResourceAlreadyExistsException.class, () -> taskService.save(modelMapper.map(TaskPrototype.aTask(), TaskDto.class)));
...
//        Task updatedTask = taskService.update(modelMapper.map(TaskPrototype.bTask(), TaskDto.class));
